...
To compile the manuscript use 'knitr' to knit the ms.Rmd file to a markdown, ms.md file. First you need to set your working directory to this respository and then you can create the markdown file by sourcing the knit_doc.R file in the R folder as follows:
