...
Studies of biological colouration have generated insights into fundamental evolutionary and ecological processes, and research into colour traits is a rapidly growing field []. The resurgent interest in biological colouration has in large part been driven by the increased availability of key technologies, including spectrometry and photography, and concurrent developments in methods for analysing colour data, such as visual models [@endler_comparing_2005; @stevens_using_2007; @kelber_animal_2003]. While such advances are positive for the field, the rapid rate of progression means that a deep understanding of common methods is increasingly beyond the grasp of the average researcher. As a consequence, the subtle complexity of many techniques [e.g. the 3-7 parameters that define a typical visual model; @endler_comparing_2005; @vorobyev_receptor_1998] is often overlooked by empiricists, which leads to critical methodological information often not being reported (Fig. 1).  

Replication and transparency lie at the heart of the scientific enterprise. The full replication of individual studies based on independently collected data is the gold standard in cumulative science. This may often be unfeasible however, especially in field-based research, which includes a great deal of research on colour-traits []. In contrast, reproducibility - the re-analysis of a study's data by independent researchers - has been presented as a readily attainable alternative [@peng_reproducible_2006; @peng_reproducible_2011]. A study may be considered truly reproducible when it satisfies three broad criteria: (i) methods are reported completely, (ii) data are publicly archived and available, and (iii) analysis code is made publicly available, such that the chain of modification of raw data is documented and preserved. While completely reproducible research [e.g. @fitzjohn_much_2014] is a laudable goal, the considerable demands it imposes on researchers means that it will often, in practice, be unattainable. Nevertheless, even partial reproducibility is of tremendous value both to individual researchers and the broader community as it ensures greater comparability between studies, and may provide a launching point for future research.    

Our aim here to explore current levels of reproducibility in studies of biological colouration, and to outline simple ways in which they may be improved in line with points (i) - (iii) above. We begin by briefly outlining some of the most common methods for studying biological colouration. We then present a set of guidelines for the reporting of methods, and we assess a subset of the literature against these criteria to assess the current state of methods reporting in colour science. We also analyse the availability of publicly archived data and code, and suggest some tools that may be useful for increasing reproducibility.  

## Measuring and analysing colour

todo: hack this back, make it more relevant to reproducibility

Generations of biologists have endeavoured to explain the mechanisms and functions of animal and plant colouration [@thayer_concealing_1909; @poulton_colours_1890; @wallace_natural_1891], and identifying best practices in measuring colour has been a great challenge. The application of spectrometry to questions of biological colouration revolutionized the field [@dyck_determination_1966]. Now relatively inexpensive and convenient, spectrometry allows the capture of quantitative and arguably repeatable data and has been rapidly taken up by researchers the field. However one drawback to this methodology, is the ease with which erroneous data can be collected if attention is not paid to finer details of spectrum capture. The angle from which spectra are taken [@santos_strong_2007], consistent calibration of light and dark standards, the distance between light source and surface, and the size, shape, glossiness or iridescence of the specimen can all contribute to variation in data and potentially bias results [@andersson_quantifying_2006; @kemp_ornamental_2008; @meadows_quantifying_2011; @schaefer_birds_2008]. Experience, guidance, consistency and objectivity (e.g. double-blind experimental design) are necessary to ensure data are repeatable and representative of the subject. Crucially, to ensure repeatability across studies, the conditions under which data were collected must be reported exactly.  
